...
const Comments: React.FunctionComponent<Props> = (props: Props) => {
  ...
  return (
    ...
    >
      ...
      <textarea onChange={onInputChange} value={review} className="reviews__textarea form__textarea" id="review" name="review" placeholder="Tell how was your stay, what you like and what can be improved"></textarea>
